$(function () {
    $('#employeesexamtitle').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "/Employee/ExamTitle/GetExamTitles",
        "columnDefs": [
            {
                "orderable": false,
                "targets": 1,
    ...
    $('#employeesexamtitle_filter').addClass("text-right");

    $('#employeesexamtitle').on('click', '.show-bs-modal', function (event) {
        var id = $(this).data("id");
