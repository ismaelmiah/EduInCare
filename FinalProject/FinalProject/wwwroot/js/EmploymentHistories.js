$(function () {
    $('#EmploymentHistories').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "/Employee/EmploymentHistory/GetEmploymentHistories",
        "columnDefs": [
            {
                "orderable": false,
                "targets": 6,
    ...
    $('#EmploymentHistories_filter').addClass("text-right");

    $('#EmploymentHistories').on('click', '.show-bs-modal', function (event) {
        var id = $(this).data("id");
