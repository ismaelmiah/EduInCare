...
namespace FinalProject.Web.Migrations
{
    ...
    [Migration("20210314105135_StudentImageAdded")]
    partial class StudentImageAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foundation.Library.Entities.StudentParents", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Foundation.Library.Entities.Student", b =>
                {
                    b.HasOne("Foundation.Library.Entities.Course", "EnrollCourse")
                        .WithMany()
                        .HasForeignKey("EnrollCourseId");

                    b.HasOne("Foundation.Library.Entities.StudentParents", "ParentsInfo")
                        .WithMany()
                        .HasForeignKey("ParentsInfoId");

                    b.HasOne("Foundation.Library.Entities.Address", "PermanentAddress")
                        .WithMany()
                        .HasForeignKey("PermanentAddressId");

                    b.HasOne("Foundation.Library.Entities.Image", "PhotoImage")
                        .WithMany()
                        .HasForeignKey("PhotoImageId");

                    b.HasOne("Foundation.Library.Entities.Address", "PresentAddress")
                        .WithMany()
