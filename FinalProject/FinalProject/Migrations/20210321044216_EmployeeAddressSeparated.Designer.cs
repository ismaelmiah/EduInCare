...
namespace FinalProject.Web.Migrations
{
    ...
    [Migration("20210321044216_EmployeeAddressSeparated")]
    partial class EmployeeAddressSeparated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foundation.Library.Entities.EmployeeAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Foundation.Library.Entities.EmployeeAddress", b =>
                {
                    b.HasOne("Foundation.Library.Entities.Employee", "Employee")
                        .WithOne("Address")
                        .HasForeignKey("Foundation.Library.Entities.EmployeeAddress", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
